pipeline {
    ...
    environment {
        GITHUB_URL = 'https://github.com/diallof2/metallb-deploy.git'  // <---- Change this to match your cloned repository
        KUBECONFIG = credentials('diallof2-225')   // <---- Change this to match your kubernetes cluster credentials
    }
